...
if(n===1){if(spaces[0]>capacity){
  ...
  // let isPutValues=calMaxValue(spaces.slice(0,n-1),values.slice(0,n-1),capacity-spaces[n-1])+values[n-1]
  let isPutValues
  ...
  // console.log("capacity:", capacity, "spaces:", spaces[n-1]);
  // console.log('isPutValues',isPutValues)
