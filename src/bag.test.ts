import { calMaxValue, calMaxValue1, calMaxValue2 } from "./bag";
...
test("calMaxValue2 should return for", () => {
  const result = calMaxValue2([1, 2, 3], [1, 2, 3], 3);
  expect(result).toBe(3);
});

test("calMaxValue2 should return for", () => {
  const result = calMaxValue2([1, 2, 3], [1, 2, 3], 5);
  expect(result).toBe(5);
});

test("calMaxValue2 should return for", () => {
  const result = calMaxValue2([1, 3, 8], [2, 5, 9], 15);
  expect(result).toBe(16);
});

test("calMaxValue2 should return for", () => {
  const result = calMaxValue2([3, 2, 1], [3, 2, 1], 4);
